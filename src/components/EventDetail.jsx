...
const TheatreIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    {/* Lucide "drama" — two theatre masks fused at the centre */}
    <path d="M10 11h.01" />
    <path d="M14 6h.01" />
    <path d="M18 6h.01" />
    ...
    <path d="M9.8 12.8c-1.2-.1-2.2-.4-3.1-.9" />
  </svg>
)
      ...
      >
        ...
        >
          ...
          <div className="event-detail-hero">
            ...
            >
              <span className="event-detail-source-icon" aria-hidden="true">
                {event.categories?.[0] === 'music' ? <MusicIcon /> : <TheatreIcon />}
              </span>
              {sourceInfo.name}
            </motion.span>
          </div>
