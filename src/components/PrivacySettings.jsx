...
export default function PrivacySettings() {
  ...
  return (
    <div className="privacy-settings">
      ...
      {/* Public Visited Map Toggle */}
      <button
        className={`privacy-settings-toggle ${currentSettings?.isMapPublic ? 'active' : ''}`}
        onClick={() => handleToggle('isMapPublic')}
        disabled={saving}
        aria-pressed={currentSettings?.isMapPublic}
      >
        <span className="toggle-icon">
          <MapPinIcon />
        </span>
        ...
        <span className={`toggle-switch ${currentSettings?.isMapPublic ? 'on' : ''}`}>
          <span className="toggle-knob" />
        </span>
      </button>
