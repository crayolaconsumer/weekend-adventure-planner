...
async function opens(slug, at) {
  ...
  return slug === canonical || slug.startsWith(`${canonical}-`) ? 'yes' : 'no'
}
...
// Every slug is verified to open that UK town on /town/<slug>. Do not edit by hand. ${slugs.length} towns.
export const UK_TOWN_SLUGS = ${JSON.stringify(slugs)}
`)
