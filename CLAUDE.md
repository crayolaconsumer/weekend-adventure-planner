...
These override everything else. If a rule conflicts with another instruction, the rule wins.
...
Define success criteria. Loop until verified. Don't follow a fixed list of steps — state what success looks like and iterate until it's true.
